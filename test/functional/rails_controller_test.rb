...
class RailsControllerTest < ActionController::TestCase
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post :create, rail: { Message: @rail.Message, Message: @rail.Message, Title: @rail.Title, g: @rail.g, scaffold: @rail.scaffold }
    end
  ...
  test "should update rail" do
    put :update, id: @rail, rail: { Message: @rail.Message, Message: @rail.Message, Title: @rail.Title, g: @rail.g, scaffold: @rail.scaffold }
    assert_redirected_to rail_path(assigns(:rail))
  end
